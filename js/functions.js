 ...
 * @returns {string} inputValue coin symbol, in lowercase
 */
function getCoinSymbol(inputValue) {
  if(typeof inputValue !== 'string') return inputValue;

  inputValue = inputValue.toLowerCase();
  if (inputValue.includes('eos')) return 'eos';
  if (inputValue.includes('bitcoin')) return 'btc';
  if (inputValue.includes('ethereum')) return 'eth';
  if (inputValue.includes('litecoin')) return 'ltc';
  if (inputValue.includes('monero')) return 'xmr';
  if (inputValue.includes('oxen')) return 'Oxen';
  if (inputValue === 'nxt' || inputValue === 'ardr' || inputValue === 'ardor') return 'ignis';
